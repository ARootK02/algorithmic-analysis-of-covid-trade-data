...
int main(){
    ...
    cout<<"Choose one of the following sorts by typing it's number:"<<endl<<"1.CountingSort"<<endl<<"2.MergeSort"<<endl;
    cin>>choice;
    ...
    cout<<setw(10)<<"Direction"<<setw(15)<<"Year"<<setw(15)<<"Date"<<setw(15)<<"Weekday"<<setw(35)<<"Country"<<setw(40)<<"Commodity"<<setw(25)<<"Transport_Mode"<<setw(15)<<"Measure"<<setw(15)<<"Value"<<setw(15)<<"Cumulative"<<endl;
    ...
    for(int i=0; i<displayLimit; i++)
        cout<<setw(10)<<reg[i].Direction<<setw(15)<<reg[i].Year<<setw(15)<<reg[i].Date<<setw(15)<<reg[i].Weekday<<setw(35)<<reg[i].Country<<setw(40)<<reg[i].Commodity<<setw(25)<<reg[i].Transport_Mode<<setw(15)<<reg[i].Measure<<setw(15)<<reg[i].Value<<setw(15)<<reg[i].Cumulative<<endl;
